...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
    ...
    if (self) {
        ...
        int on = [[[[NSUserDefaults alloc] initWithSuiteName:@"com.nightwind.folderartworkremadeprefs"] objectForKey:@"tweakEnabled"] intValue];
